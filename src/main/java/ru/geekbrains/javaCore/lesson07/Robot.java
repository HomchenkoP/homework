...
public class Robot implements Participantable {
    ...
    public Robot (String name) {
        this.name = name;
        this.runAbility = rand.nextInt(500);
        this.jumpAbility = rand.nextInt(2);
    }

    public void info() {
        System.out.println("Робот " + name + " может пробежать " + this.runAbility + " и перепрыгнуть " + this.jumpAbility + ".");
    }
